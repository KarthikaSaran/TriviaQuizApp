...
{  
    ...
    if(j===20){
        clearInterval(inter);
         var msg = "<div style='align:left;color:green;'><h2 style='color:white;'> Trivia Quiz Results </h2><h4>Congratulations <span style='color:blue'>"+firstname+" " +lastname+"!!!</span></h4><hr><span style='color:#4B0082;'> Your score is "+score+"/10</span><hr></div>";
...
function timer()
{
    ...
    {
        clearInterval(inter);
        var msg = "<div style='align:left;color:green;'> <h2 style='color:white'>Trivia Quiz Results </h2> Time Up !<hr><h4>Congratulations <span style='color:blue'>"+firstname+" " +lastname+"!!!</span></h4><hr><span style='color:#4B0082'> Your score is "+score+"/10</span><hr></div>";
        document.getElementById("ques").innerHTML=msg;
    }
    else
